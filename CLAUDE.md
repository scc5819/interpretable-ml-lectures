...
- **Re-adding governance boilerplate** (code of conduct, security policy,
  review-expectations sections). Deliberately minimal: the docs stay short
  and in a peer voice, and CI carries the quality bar. Keep new prose in the
  same register — practical, collegial, nothing that reads as policing.
