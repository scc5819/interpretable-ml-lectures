...
## 2026-08-25 — simpler contributor docs

- Slimmed the repository down to what contributors actually use: a shorter
  CONTRIBUTING (setup, evidence bar as three short rules, module how-to,
  contact), and the Code of Conduct, SECURITY.md, SUPPORT.md and devcontainer
  files removed. The quality bar is unchanged — CI executes the notebooks
  and checks every convention on every PR.
